...
import com.af2905.beawareofmovies.Constants.CATEGORY_USER_WATCH_MOVIES
...
class UserWatchLocalRepository(private val database: MovieDatabase) : MovieRepository<MovieVo> {

    override fun getMovies(): Observable<List<MovieVo>> {
        return database.movieDao().getAll(CATEGORY_USER_WATCH_MOVIES)
